                            ...
                            <Col size={3} className="valign-wrapper" style={{height: "100%"}}>
                                {
                                    ...
                                    <button className='btn-flat waves-effect waves-light yellow' name="create" onClick={this.handleSubmit} width="100%" type='submit'>Create
                                    <i className='material-icons right'>send</i>
                                    </button>
                                    :
                                    <button className='btn-flat waves-effect waves-light yellow' name="edit" onClick={this.handleSubmit} width="100%" type='submit'>Save
                                    <i className='material-icons right'>send</i>
                                    </button>
                                }
                            </Col>  
