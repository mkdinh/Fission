            ...
            <div>
                <div className="valign-wrapper" style={{...style.preview, height: this.props.editor ? "25vh" : "67.3vh"}}>
                    ...
                    <div className="row preview-footer" style={{height: "90px", color: "#ffc107", fontSize: "12px", textAlign:"center", border:"none"}}>
                            <Col size={4}>
                                <input id="component_name" underlineFocusStyle={{color: pinkA200}} style={{color: "#ffc107", fontSize: "12px", textAlign:"center", border:"none", borderBottomColor: "#ffc107"}} name="name" value={this.state.name} onChange={this.handleChange} placeholder="Component Name"/>
                            </Col>
                            <Col size={2}>
                                <input name="group" underlineFocusStyle={{color: pinkA200}} style={{color: "#ffc107", fontSize: "12px", textAlign:"center", border:"none"}} value={this.state.group} onChange={this.handleChange} placeholder="Group Name"/>
                            </Col>
                            <Col size={3}>
